...
<link rel='stylesheet'   href='/news/wp-content/themes/libraries/css/mobile.css' type='text/css' media='all' />
		...
		<div class="studySpacesPage" id="stage" role="main">
					...
					<ul class="list--study-spaces">
						...
						?>
							<li class="flex-container study-space">
								...
								<div class="content--study-space midStudy">
									<h3><a href="<?php echo $pageLink; ?>"><?php echo the_title() ?></a></h3>
									<div class="description">
										<?php echo $description; ?>
									</div>
									<?php if ($reserveUrl != ""): ?>
											<a class="reserve hidden-phone" href="<?php echo $reserveUrl; ?>"><?php echo $reserveText; ?></a><span> | </span>
									<?php endif; ?>
									<?php if ($study24 == 1): ?>
